  ...
  var DEVICE_TRANSFER_DEVICES = [
    {
      ...
      sendStep: [
        "Android 標準アプリ「Files」などのファイルやフォルダを選択できるアプリを開きます。",
        "送信するデータが保存されたフォルダを開きます（通常「ダウンロード」フォルダに入っていることが多い）。",
        "送るファイルを長押しします（なお、ファイルは ZIP 形式の圧縮ファイルになっています）。",
        "「共有」を押します。",
    ...
    },
    {
      ...
      sendStep: [
        ...
        "送るファイルを右クリックします（なお、ファイルは ZIP 形式の圧縮ファイルになっています）。",
    ...
    },
    {
      ...
      sendStep: [
        "標準アプリの「ファイル」を開きます。見つからない場合はホームで「ファイル」と検索してください。",
        "「ダウンロード」を開きます。",
        "送るファイルを長押しします（なお、ファイルは ZIP 形式の圧縮ファイルになっています）。",
        "「共有」を押します。",
    ...
    },
    {
      ...
      sendStep: [
        "「ダウンロード」フォルダを開きます。",
        "送るファイルを選びます（なお、ファイルは ZIP 形式の圧縮ファイルになっています）。",
        "ファイルを右クリック（controlキーを押しながらクリック）して、「共有」を選びます。",
        "「AirDrop」を押して、送り先を選びます。",
      ],
      receiveStep: [
        "次の画面で、他の端末から AirDrop でファイルが送られたフォルダを開きます（通常「ダウンロード」フォルダに入ることが多い）。",
